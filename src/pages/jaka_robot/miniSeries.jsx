...
import styles from "./miniSeries.module.scss";
...
export default function MiniSeries() {
  ...
  const imagePath =
    currentLang === "kr"
      ? "/assets/product_comparison/kr/jaka_mini_product_comparison_kr.png"
      : "/assets/product_comparison/en/jaka_mini_product_comparison_en.png";

  const aboutList = t("jaka_mini.about", {
    returnObjects: true,
  });
  ...
  return (
    <>
      ...
      <section className="page_title">
        <PageTitle title={t("jaka_mini.page_title")} />
      </section>

      <section className="mini_series">
        <div className={styles.page_subtitle}>
          <span>{t("jaka_mini.page_subtitle")}</span>
        </div>

        <section className="mini_series_information">
          <div className={styles.product_container}>
            <div className={styles.product_info}>
              <section className={styles.product_img_section}>
                <div className={styles.product_img}>
                  <img
                    src="/assets/jaka_mini/mini.webp"
                    alt="제품 이미지"
                  />
                </div>
              </section>
      ...
      <section className="product_comparison">
        <div className={styles.comparison_title}>
          <span>{t("jaka_mini.comparison_title")}</span>
        </div>
      ...
      <section className="feature_component">
        <div className={styles.feature_title}>
          <span>{t("jaka_mini.feature_title")}</span>
        </div>
