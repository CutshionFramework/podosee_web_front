...
import SSeriesPage from './pages/product_detail/s/sSeriesPage';
    ...
    <>
      <I18nextProvider i18n={i18n}>
        <Routes>
          ...
          <Route path='/jaka/allinoneseries' element={<AllInOneSeries />} />
          ...
          <Route path='/jaka/sseries/:id' element={<SSeriesPage />} />
