...
import SSeries from "./pages/jaka_robot/sSeries";
import AllInOneSeries from "./pages/jaka_robot/allInOneSeries";
import ProSeries from "./pages/jaka_robot/proSeries";
import MiniSeries from "./pages/jaka_robot/miniSeries";
    ...
    <>
      <I18nextProvider i18n={i18n}>
        <Routes>
          ...
          <Route path="/jaka/sseries" element={<SSeries />} />
          <Route
            path="/jaka/allinoneseries"
            element={<AllInOneSeries />}
          />
          <Route path="/jaka/proseries" element={<ProSeries />} />
          <Route path="/jaka/miniseries" element={<MiniSeries />} />

          {/* Product series */}
          <Route
            path="/jaka/zuseries/:id"
            element={<ZuSeriesPage />}
          />
          <Route
            path="/jaka/allinone/:id"
            element={<AllInOneSeriesPage />}
          />
          <Route
            path="/jaka/proseries/:id"
            element={<ProSeriesPage />}
          />
